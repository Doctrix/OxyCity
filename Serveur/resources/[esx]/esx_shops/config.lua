...
Config.Map = {
  ...
  {name="Super Market",color=2, id=52,x =373.875, y =325.896, z =100.319},
  {name="Lojas",color=2, id=52,x =2557.458, y =382.282, z =100.319},
  {name="Lojas",color=2, id=52,x =-3038.939, y =585.954, z =6.908},
  {name="Epicerie du coin",color=2, id=52,x =-3241.927, y =1001.462, z =11.830},
  ...
  {name="Vital",color=2, id=52,x =1729.216, y =6414.131, z =34.037},
